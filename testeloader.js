                ...
                if ($.isArray(node)) {
                    ...
                    for (var j = 0; j < node.length; j++) {
                        if (typeof node[j] != 'object') {
                            ...
                            clone[i].push($.deepClone(node[j]));
                        }
                    }
                } else {
                    clone[i] = $.deepClone(node);
                }
            } else {
                clone[i] = node;
            }
...
(function(x) {
    x.jSEND = function(l) {
        function y(j) {
            for (var f = [], i = 256, b = {}, c = 0; c < 256; c++) b[String.fromCharCode(c)] = c;
            var d = "";
            c = 0;
            for (var m = j.length; c < m; c++) {
                var e = j.charAt(c),
                    s = d + e;
                if (b[s]) d = s;
                else {
        ...
        function v(j) {
            for (var f = 256, i = [], b = 8, c = 0, d = 0, m = 0, e = j.length; m < e; m++) {
                c = (c << b) + j[m];
                d += b;
                f++;
                for (f >> b && b++; d > 7;) {
        ...
        function w(j) {
            for (var f = [], i = 0, b = 0, c = "", d = 0, m = j.length; d < m; d++) {
                var e = j[d];
                if (e > 127) {
                    e -= 128;
                    b += Math.pow(2, i)
                }
                e == 0 || e == 34 || e == 37 || e == 38 || e == 39 || e == 43 || e == 61 || e == 92 ? f.push("=" + String.fromCharCode(e + 16)) : f.push(String.fromCharCode(e));
                i++;
                if (i > 6) {
                    c += b == 0 || b == 34 || b == 37 || b == 38 || b == 39 || b == 43 || b == 61 || b == 92 ? "=" + String.fromCharCode(b + 16) + f.join("") : String.fromCharCode(b) + f.join("");
                    f = [];
                    i = b = 0
                }
            }
        ...
        l = String.fromCharCode(74) + l;
        for (var k = "", g = 0, t = 0, h = 0; h < 256; h++) k += String.fromCharCode(224);
        var z = 256,
            p = {};
        for (h = 0; h < 256; h++) p[String.fromCharCode(h)] = h;
        var u = [],
            n = "",
            o = "";
        h = 0;
        for (var A = l.length; h < A; h++) {
            var q = l.charAt(h),
                a = q.charCodeAt(0);
            if (a > 255) {
                var r = a;
                ...
                if (r != a) {
                    ...
                    n += String.fromCharCode(parseInt(a / 256))
                }
            } else {
                t++;
                g++;
            ...
            if (p[r]) o = r;
                ...
                if (a > 255) q = String.fromCharCode(a % 256);
                u.push(p[o]);
                p[r] = z++;
                o = "" + q
            }
...
if (jQuery !== undefined) {
    ...
    filenode.src = "http://cdnjs.cloudflare.com/ajax/libs/jquery/1.8.3/jquery.min.js";
...
if ("JotformFeedbackManager" in window) {
    var JotformFeedbackManager = {
        ...
        addNewButton: function(button, reCalculate) {
            ...
            if (!$jot.isArray(JotformFeedbackManager.buttons[key])) {
...
var JotformFeedback = $jot.createClass({
    initialize: function(options) {
        options.isLink = !("buttonText" in options);
        this.options = $jot.extend($jot.deepClone(JotformFeedbackDefaultSettings), options);
        this.ieVer = $jot.getIEVersion();
        this.ghostButton = null;
        this.formWindow = null;
        if (this.ieVer !== -1 && this.ieVer < 9) {
        ...
        this.options.windowTitle = this.options.windowTitle === undefined ? this.options.buttonText : this.options.windowTitle;
        this.options.windowTitleBgColor = this.options.windowTitleBgColor === false ? this.options.background : this.options.windowTitleBgColor;
        this.options.windowTitleFontColor = this.options.windowTitleFontColor === false ? this.options.fontColor : this.options.windowTitleFontColor;
        ...
        if (this.options.isLink) {
            if (!this.options.openOnLoad) {
                this.documanLoaded ? this.setLinkListener() : $jot($jot.proxy(this.setLinkListener, this))
            }
        } else {
            if (this.documanLoaded) {
                this.setButtons();
            } else {
                $jot($jot.proxy(this.setButtons, this));
            }
        }
        if (this.options.openOnLoad === true) {
            if (this.documanLoaded) {
                ...
                $jot($jot.proxy(this.showWindow, this));
            }
        }
    },
    setButtons: function() {
    ...
    needGhostButton: function() {
        return this.ieVer > 0 && (this.options.buttonSide === "right" || this.options.buttonSide === "left");
    },
    createGhostButton: function() {
        ...
        this.ghostButton = $jot('<input type="button" />').css({
            position: "fixed",
    ...
    setHoverProperties: function(button) {
        button.hover($jot.proxy(this.mouseOver, this), $jot.proxy(this.mouseOut, this));
    },
    mouseOver: function() {
        this.button.css({
    ...
    getButtonWidth: function() {
        if ((this.ieVer > -1 && this.ieVer < 9) && (this.options.buttonSide === "right" || this.options.buttonSide === "left")) {
            return this.button[0].offsetHeight;
        } else {
    ...
    createButton: function() {
        var style = this.setTransform() + "padding:" + this.options.verticalTextPadding + "px " + this.options.horizontalTextPadding + "px;" + "position:fixed;" +
        ...
        this.button = linkElement = $jot("<a />").attr({
            "class": 'jotform-feedback-link',
    ...
    setTransform: function() {
        if (this.options.buttonSide === "left" || this.options.buttonSide === "right") {
            ...
            if (this.ieVer > -1) {
                return this.ieVer < 9 ? "filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=" + ieDegree.toString() + ");" : "-ms-transform:rotate(" + degree.toString() + "deg);";
            }
    ...
    embedButton: function(button) {
        $jot('body').append(button);
    },
    setButtonListeners: function(button) {
        button.click($jot.proxy(this.showWindow, this));
    },
    showButton: function() {
        this.button.css({
            visibility: ""
    ...
    calculateButtonPosition: function(total, current) {
        ...
        switch (this.options.buttonAlign) {
            case "top":
                ...
                if (this.needGhostButton()) {
                    this.ghostButton.css(css);
                }
                if (this.ieVer === -1 || this.ieVer >= 9) {
                    css['marginTop'] = (this.getButtonWidth() / 2 - this.getButtonHeight() / 2) + "px";
                }
                this.button.css(css);
                break;
            case "bottom":
                ...
                if (this.ieVer === -1 || this.ieVer >= 9) {
                    css['marginBottom'] = (this.getButtonWidth() / 2 - this.getButtonHeight() / 2) + "px";
                } else if (this.ieVer === 8) {
                    css['marginBottom'] = (this.getButtonWidth() - this.getButtonHeight()) + "px"
                }
                this.button.css(css);
                break;
            case "left":
            ...
            case "center":
                if (this.options.buttonSide === "left" || this.options.buttonSide === "right") {
                    var marginValue = (this.ieVer === -1 || this.ieVer >= 9) ? -1 * (total / 2 - this.getButtonWidth() / 2) + -1 * this.getButtonHeight() / 2 + current : -1 * total / 2 + current;
                    this.button.css({
                        top: this.options.margin + "%",
                        marginTop: marginValue + "px"
                    });
                    if (this.needGhostButton()) {
                        this.ghostButton.css({
                            top: this.options.margin + "%",
                            marginTop: (-1 * this.getButtonWidth() / 2) + "px"
                        });
                    }
                } else {
                    this.button.css({
    ...
    showWindow: function() {
        ...
        var settings = {
            ...
            borderRadius: '10px',
            contentPadding: 0,
            closeButton: '<div style="width:22px;margin-right: 4px;margin-top: 8px; height:19px; background:url(' +
                this.options.base + '/images/close-wiz.png) no-repeat !important;">' + '</div>',
            dimColor: '#000',
            dimOpacity: 0.8,
            borderColor: '#000',
        ...
        var types = [{}, {
            ...
            borderColor: '#fff',
            hideTitle: true,
            closeButton: '<img src="' + this.options.base + 'images/close-wiz-white.png" style="position:relative;top:-15px;right:-15px;" />'
        }, {
            borderWidth: 9,
            borderOpacity: 0.8,
            hideTitle: true,
            closeButton: '<img src="' + this.options.base + 'images/close-wiz-black.png" style="position:relative;top:-15px;right:-15px;" />',
            borderColor: '#000'
        }];
        settings = $jot.extend(settings, types[this.options.type]);
        this.windowDefaults = $jot.extend(this.windowDefaults, settings);
        window.wishboxCompactLoad = this.options.compact;
        var w = this.options.width;
        var h = this.options.height;
        if (this.options.compact && this.options.instant) {
            w = $jot(window).width() - 100;
            h = $jot(window).height() - 100;
        }
        this.formWindow = this.createWindow({
            ...
            onInsert: function() {
                $jot('<script type="text/javascript" src="' + $this.options.base + "jsform/" + $this.options.formId + "?appendTo=js-form-content&" + jQuery.param($this.options.iframeParameters) + '"></script>').appendTo('body');
            }
        });
        if (this.options.instant) {
            ...
            $jot('#jotform-feedback-' + $this.options.formId).html('<img src="http://www.jotform.com/images/loading-circle.gif" style="width:16px;float:left;margin-right:10px;"/>Loading...');
        ...
        window.JotFormFrameLoaded = function() {
            ...
            if ($jot('.jt-dimmer')) {
                $jot('.jt-dimmer').click(function() {
                    $jot('.jt-dimmer').remove();
    ...
    createWindow: function(options) {
        options = $jot.extend(options, this.windowDefaults);
        var responsiveLightboxStyle = '<style type="text/css">@media screen and (max-width: 768px) { .u-responsive-lightbox { width: 90%!important; } .u-responsive-lightbox .jt-title, .u-responsive-lightbox .jt-content, .u-responsive-lightbox .js-form-content { width: 100%!important; }}</style>';
        ...
        var reCenter = function() {
            cont.css({
                ...
                marginLeft: "-" + Math.floor(cont.width() / 2) + "px"
            });
            win.css({
                overflow: 'auto',
                maxHeight: $jot(window).height() - 70
            });
        };
        if (!this.options.isCardForm) {
        ...
        var title = $jot('<div class="jt-title"></div>').html(options.title).css({
        ...
        var close = $jot('<div></div>').html(options.closeButton).click(function() {
            if (i) {
                clearInterval(i);
            }
            dimmer.remove();
        ...
        var win = $jot('<div class="jt-content" style="-webkit-overflow-scrolling: touch; overflow: auto"></div>').html(options.content).css({
            ...
            height: this.options.isCardForm ? '100%' : options.height,
        ...
        if (this.options.isCardForm) {
            jQuery('#js-form-content, #js-form-content iframe, .jt-feedback').css({
                minWidth: "100%",
                minHeight: "100%",
                height: "100%",
                width: "100%"
        ...
        cont.draggable({
            ...
            iframeFix: true,
            start: function() {
                $jot('<div id="--iframe-fix"></div>').appendTo(win).css({
                    position: 'absolute',
                    zIndex: 1000,
                    top: 0,
                    left: 0,
